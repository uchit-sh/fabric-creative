				...
				<div className="rde-editor-footer-toolbar-zoom">
					<Button.Group>
						<CommonButton
							...
							icon="search-minus"
							tooltipTitle={'action.zoom-out'}
						/>
						<CommonButton
							onClick={() => {
								canvasRef.handler.zoomHandler.zoomOneToOne();
							}}
							tooltipTitle={'action.one-to-one'}
						>
							{`${zoomValue}%`}
						</CommonButton>
						<CommonButton
						...
						<CommonButton
							...
							icon="search-plus"
							tooltipTitle={'action.zoom-in'}
						/>
					</Button.Group>
				</div>
				<div className="rde-editor-footer-toolbar-preview">
					<Tooltip title={'action.preview'}>
