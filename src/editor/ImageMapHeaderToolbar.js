			...
			<Flex className="rde-editor-header-toolbar-container" flex="1">
				<Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-list">
					<CommonButton
						...
						shape="circle"
						icon="layer-group"
						tooltipTitle={'action.canvas-list'}
					/>
				...
				<Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-alignment">
					<CommonButton
						...
						icon="angle-up"
						tooltipTitle={'action.bring-forward'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						icon="angle-down"
						tooltipTitle={'action.send-backwards'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						tooltipTitle={'action.bring-to-front'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						tooltipTitle={'action.send-to-back'}
					/>
				</Flex.Item>
				<Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-alignment">
					<CommonButton
						...
						icon="align-left"
						tooltipTitle={'action.align-left'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						icon="align-center"
						tooltipTitle={'action.align-center'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						icon="align-right"
						tooltipTitle={'action.align-right'}
					/>
				</Flex.Item>
				<Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-group">
					<CommonButton
						...
						icon="object-group"
						tooltipTitle={'action.object-group'}
					/>
					<CommonButton
						className="rde-action-btn"
						shape="circle"
						...
						icon="object-ungroup"
						tooltipTitle={'action.object-ungroup'}
					/>
				</Flex.Item>
				<Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-crop">
					...
					<CommonButton
						...
						icon="times"
						tooltipTitle={'action.crop-cancel'}
					/>
				</Flex.Item>
