...
export default {
	render(canvasRef, form, data) {
		...
		return (
			<React.Fragment>
				<Form.Item label={'imagemap.shadow.shadow-enabled'} colon={false}>
				...
				{enabeld ? (
					<React.Fragment>
						<Form.Item label={'common.color'} colon={false}>
							{getFieldDecorator('shadow.color', {
								initialValue: data.shadow.color || 'rgba(0, 0, 0, 0)',
							})(<ColorPicker />)}
						</Form.Item>
						<Form.Item label={'common.blur'} colon={false}>
						...
						<Form.Item label={'imagemap.shadow.offset-x'} colon={false}>
						...
						<Form.Item label={'imagemap.shadow.offset-y'} colon={false}>
