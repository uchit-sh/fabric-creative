	...
	render(canvasRef, form, data) {
		...
		return (
			<React.Fragment>
				<Row>
					<Col span={12}>
						<Form.Item label={'common.locked'} colon={false}>
					...
					<Col span={12}>
						<Form.Item label={'common.visible'} colon={false}>
				...
				<Row>
					<Col span={12}>
						<Form.Item label={'common.left'} colon={false}>
					...
					<Col span={12}>
						<Form.Item label={'common.top'} colon={false}>
