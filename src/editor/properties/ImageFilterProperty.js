    ...
    render(canvasRef, form, data) {
        ...
        return (
            <Row>
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.grayscale'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.invert'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.sepia'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.brownie'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.vintage'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.blackwhite'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.technicolor'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.polaroid'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.sharpen'}>
                            {
                    ...
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.emboss'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.gamma'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.brightness'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.contrast'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.saturation'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.hue'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.noise'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.pixelate'}>
                            {
                ...
                <Row>
                    <Col md={24} lg={6}>
                        <Form.Item label={'imagemap.filter.blur'}>
                            {
