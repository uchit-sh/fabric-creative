...
export default {
	render(canvasRef, form, data) {
		...
		return (
			<React.Fragment>
				<Form.Item label={'imagemap.animation.animation-type'} colon={false}>
					{getFieldDecorator('animation.type', {
						initialValue: type,
					})(
						<Select>
							<Select.Option value="none">{'imagemap.animation.none'}</Select.Option>
							<Select.Option value="fade">{'imagemap.animation.fade'}</Select.Option>
							<Select.Option value="bounce">{'imagemap.animation.bounce'}</Select.Option>
							<Select.Option value="shake">{'imagemap.animation.shake'}</Select.Option>
							<Select.Option value="scaling">{'imagemap.animation.scaling'}</Select.Option>
							<Select.Option value="rotation">{'imagemap.animation.rotation'}</Select.Option>
							<Select.Option value="flash">{'imagemap.animation.flash'}</Select.Option>
						</Select>,
					)}
				</Form.Item>
				{type === 'none' ? null : (
					<React.Fragment>
						<Row>
							<Col span={12}>
								<Form.Item label={'imagemap.animation.auto-play'} colon={false}>
							...
							<Col span={12}>
								<Form.Item label={'common.loop'} colon={false}>
						...
						{type !== 'shake' ? (
							<Row>
								<Col span={12}>
									<Form.Item label={'common.delay'} colon={false}>
								...
								<Col span={12}>
									<Form.Item label={'common.duration'} colon={false}>
						...
						<Form.Item label={'imagemap.animation.playback'} colon={false}>
							<Row>
								<Col span={8}>
									<Button
										block
	...
	getComponentType(type, data, getFieldDecorator) {
		...
		if (type === 'fade') {
			component = (
				<Form.Item label={'common.opacity'} colon={false}>
			...
			component = (
				<React.Fragment>
					<Form.Item label={'imagemap.animation.bounce-type'} colon={false}>
					...
					<Form.Item label={'common.offset'} colon={false}>
			...
			component = (
				<React.Fragment>
					<Form.Item label={'imagemap.animation.shake-type'} colon={false}>
						{getFieldDecorator('animation.shake', {
							initialValue: data.animation.shake || 'hotizontal',
						})(
							<Select>
								<Select.Option value="hotizontal">{'common.horizontal'}</Select.Option>
								<Select.Option value="vertical">{'common.vertical'}</Select.Option>
							</Select>,
						)}
					</Form.Item>
					<Form.Item label={'common.offset'} colon={false}>
			...
			component = (
				<Form.Item label={'imagemap.animation.scaling'} colon={false}>
			...
			component = (
				<Form.Item label={'common.angle'} colon={false}>
			...
			component = (
				<Row>
					<Col span={12}>
						<Form.Item label={'imagemap.style.fill-color'} colon={false}>
					...
					<Col span={12}>
						<Form.Item label={'imagemap.style.stroke-color'} colon={false}>
			...
			component = (
				<Row>
					<Col span={12}>
						<Form.Item label={'common.value'} colon={false}>
